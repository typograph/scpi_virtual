...
#        self.add_notimplemented('*OPC')
    ...
    def set_current_limit(self, parsed_value):
        self.current_limit = get_float_value(parsed_value, default=100.0, min_max=(0, 100), units='A')
...
# Ramp Target/Rate Configuration Commands and Queries
    ...
    def set_field_target(self, parsed_value): # <field (kG, T)>
        self.field_target = get_float_value(parsed_value, default=0,
    ...
    @commands.add(':CONFigure:RAMP:FIELd') # <field (kG, T)>, <rate (kG/s, kG/min, T/s, T/min)>
