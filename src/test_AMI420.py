...
class TestAMI420(unittest.TestCase):
    ...
    def test_units(self):
        ...
        self.assertRun('CONF:FIELD:PROG 2kG;:FIELD:PROG?;:RAMP:FIELD?',
                       None,               '2.0000',    '2.0000,0.3000')
        self.assertEqual(self.magnet.field_target, 0.2)
        
        self.assertRun('CONF:FIELD:PROG 2T;:FIELD:PROG?;:RAMP:FIELD?',
                       None,              '20.0000',   '20.0000,0.3000')
        ...
        self.assertRun(':FIELD:PROG?;:RAMP:RATE:FIELD?;:RAMP:FIELD?',
                       '1.0000',    '18.0000',        '1.0000,18.0000')
        self.assertRun('CONF:RAMP:RATE:FIELD 0.3kG/min;:RAMP:RATE:FIELD?;:RAMP:FIELD?',
                       None,                        '0.0300',         '1.0000,0.0300')
        self.assertRun('CONF:RAMP:RATE:FIELD 0.3kG/s;:RAMP:RATE:FIELD?;:RAMP:FIELD?',
                       None,                        '1.8000',         '1.0000,1.8000')

        self.assertRun(':CURR:PROG?;:RAMP:RATE:CURR?;:RAMP:CURR?',
                       '0.6667',    '1.2000',        '0.6667,1.2000')

        self.assertRun(':CONF:CURR:PROG 1;:CURR:PROG?;:RAMP:RATE:CURR?;:RAMP:CURR?',
                       None,             '1.0000',   '1.2000',        '1.0000,1.2000')
        self.assertRun(':FIELD:PROG?;:RAMP:RATE:FIELD?;:RAMP:FIELD?',
                       '1.5000',    '1.8000',        '1.5000,1.8000')

        self.assertRun(':CONF:RAMP:RATE:CURR 1;:CURR:PROG?;:RAMP:RATE:CURR?;:RAMP:CURR?',
                       None,             '1.0000',   '1.0000',        '1.0000,1.0000')
        self.assertRun(':FIELD:PROG?;:RAMP:RATE:FIELD?;:RAMP:FIELD?',
                       '1.5000',    '1.5000',        '1.5000,1.5000')

        self.assertRun(':CONF:RAMP:CURR 1.5A,10A/s;:CURR:PROG?;:RAMP:RATE:CURR?;:RAMP:CURR?',
                       None,             '1.5000',   '600.0000',        '1.5000,600.0000')
        self.assertRun(':FIELD:PROG?;:RAMP:RATE:FIELD?;:RAMP:FIELD?',
                       '2.2500',    '900.0000',        '2.2500,900.0000')
